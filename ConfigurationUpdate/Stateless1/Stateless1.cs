...
namespace Stateless1
{
    ...
    internal sealed class Stateless1 : StatelessService
    {
        ...
        protected override async Task RunAsync(CancellationToken cancellationToken)
        {
            ...
            var configSecion = Context.CodePackageActivationContext.GetConfigurationPackageObject("Config");
            var text = configSecion.Settings.Sections["MyConfigSection"].Parameters["IncrementStep"].Value;
